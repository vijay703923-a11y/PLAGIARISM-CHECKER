...
const App: React.FC = () => {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      console.error(err);
      setError("Failed to analyze. Please check your network or try again later.");
        ...
        {status === AnalysisStatus.IDLE && !result && (
          <div className="max-w-3xl mx-auto text-center mb-16 space-y-6 animate-in fade-in slide-in-from-top-4 duration-1000">
            ...
            <p className="text-lg text-slate-500 font-medium max-w-2xl mx-auto">
              Real-time plagiarism detection, smart grammar fixing, and citations powered by Gemini 3 Grounding AI.
            </p>
          </div>
        )}
